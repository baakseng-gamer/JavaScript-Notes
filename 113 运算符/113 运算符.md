...
[1. 算术运算符](#1.算术运算符) [2. 赋值运算符](#2. 赋值运算符) [3. 一元运算符](#3.一元运算符) [4.关系运算符](#4.关系运算符) [5.逻辑运算符](#5.逻辑运算符) [6.位运算符](#6.位运算符) [7.逗号运算符](#7.逗号运算符) [8.运算符优先级](#8.运算符优先级)

[总结（类型转换表格）](#总结（类型转换表格）) [练习](#练习)
